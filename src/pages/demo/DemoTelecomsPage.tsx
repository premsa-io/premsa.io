  ...
  <div className="space-y-8">
    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        <StatCard number="14" label="Alertes noves" color="text-primary" />
        <StatCard number="4" label="Crítiques" color="text-destructive" />
    ...
    <div>
      ...
      <AlertCard
        severity="critical"
        title="RD 25/2025 - Obligació cobertura 5G zones rurals"
        source="BOE núm. 10 | Secció I"
        date="12 Gen 2025, 08:30"
        impact="Alt - Requereix inversió xarxa €80M"
        summary="Nou Reial Decret que obliga operadors amb llicència 5G a garantir cobertura en municipis <5.000 habitants. Deadline desplegament: 31 Desembre 2026. Penalitzacions per incompliment: fins €10M. Afecta 240 municipis per TeleConnect."
        expanded
      />
    </div>
    ...
    <div>
      ...
      <Card className="p-6">
        <div className="space-y-4 border-l-2 border-border pl-6">
          <TimelineItem time="17:00" text="Nova resolució CNMC processada" />
          <TimelineItem time="13:20" text="Alerta tarifes wholesales marcada com llegida" />
          <TimelineItem time="09:00" text="Email setmanal enviat a 25 usuaris" />
          <TimelineItem time="Ahir 15:45" text="4 documents nous CNMC indexats" />
        </div>
      </Card>
    </div>
  </div>
...
const AlertesView = ({
  ...
  <div className="space-y-6">
    <h1 className="font-manrope font-bold text-2xl md:text-3xl text-foreground">
      ALERTES - TeleConnect España SAU
    </h1>
    ...
    <p className="text-sm text-muted-foreground">14 alertes trobades</p>
    ...
    <AlertCardFull
      ...
      impact="Alt - Requereix inversió xarxa €80M"
      summary="Nou Reial Decret que obliga operadors amb llicència 5G a garantir cobertura en municipis <5.000 habitants. Deadline desplegament: 31 Desembre 2026. Penalitzacions per incompliment: fins €10M. Afecta 240 municipis per TeleConnect."
      context="Aquest RD desenvolupa la Llei 11/2022 (Connectivitat i Infraestructures Digitals). Històric: 2022: Llei General Telecomunicacions (obligacions cobertura). 2020: Subasta 5G amb compromisos desplegament. Normativa relacionada: Reglament UE 2015/2120 (Roaming i Internet obert), Directiva UE 2018/1972 (Codi Europeu Comunicacions Electròniques)."
      businessImpact="✓ 240 municipis rurals sense cobertura actual
✓ Inversió estimada: €80M (antenes + fibra transport)
✓ Dept. Network: Planificar desplegament 24 mesos
✓ Risc penalització si no compliment: €10M"
    />
    ...
    <AlertCardFull
      id="alert-2"
      severity="critical"
      title="Resolució CNMC 2025-045 - Reducció tarifes majoristes"
      source="BOE núm. 8 | Secció III"
      date="10 Gen 2025, 11:15"
      expanded={expandedAlerts.includes("alert-2")}
      onToggle={() => toggleAlert("alert-2")}
      impact="Alt - Reducció ingressos -€12M/any"
      summary="CNMC ordena reducció del 18% en tarifes majoristes d'accés a xarxa fibra per operadors virtuals (OMVs). Afecta ingressos wholesales. Implementació: 1 Abril 2025."
    />
    ...
    <AlertCardFull
      id="alert-3"
      severity="medium"
      title="Ordre ETD/1789/2024 - Transparència contractes"
      source="BOE núm. 9 | Secció III"
      date="11 Gen 2025, 14:00"
      expanded={expandedAlerts.includes("alert-3")}
      onToggle={() => toggleAlert("alert-3")}
      impact="Mitjà - Requereix canvis contractes clients"
      summary="Noves obligacions transparència en contractes telecom: desglos costos, dret desistiment reforçat, informació comprensible. Afecta contractes nous i renovacions. Entrada vigor: 1 Maig 2025."
    />
    ...
    <AlertCardFull
      id="alert-4"
      severity="info"
      title="Comunicació CNMC - Consulta pública eSIM"
      source="Web CNMC | 10 Gen 2025"
      date="10 Gen 2025, 16:30"
      expanded={expandedAlerts.includes("alert-4")}
      onToggle={() => toggleAlert("alert-4")}
      impact="Informatiu - Futura normativa"
      summary="CNMC obre consulta pública sobre regulació eSIM i portabilitat digital. Període al·legacions: 30 dies. Futura normativa esperada Q3 2025."
    />
...
const DocumentsView = () => (
  <div className="space-y-6">
    ...
    <Card className="p-5 flex flex-wrap gap-4 items-center">
      ...
      <Select defaultValue="all">
        ...
        <SelectContent>
          ...
          <SelectItem value="cnmc">CNMC</SelectItem>
      ...
      <Select defaultValue="all">
        ...
        <SelectContent>
          ...
          <SelectItem value="competencia">Competència</SelectItem>
    ...
    <p className="text-sm text-muted-foreground">45 documents trobats</p>

    {/* Document Cards */}
    <DocumentCard
      title="RD 25/2025 - Cobertura 5G zones rurals"
      meta="BOE núm. 10 | 12 Gen 2025 | Secció I | Pàg. 4521"
      source="https://boe.es/diario_boe/txt.php?id=BOE-A-2025-234"
      extractedDate="12 Gen 2025, 08:30"
      metadata={[
        { label: "Rang", value: "Real Decret" },
        { label: "Departament", value: "Ministerio para la Transformación Digital" },
        { label: "Deadline", value: "31 Desembre 2026" },
        { label: "Afecta a", value: "Llei 11/2022 (Connectivitat)" },
      ]}
    />
    <DocumentCard
      title="Resolució CNMC 2025-045 - Tarifes majoristes"
      meta="BOE núm. 8 | 10 Gen 2025 | Secció III | Pàg. 2789"
      source="https://boe.es/diario_boe/txt.php?id=BOE-A-2025-189"
      extractedDate="10 Gen 2025, 11:15"
      metadata={[
        { label: "Rang", value: "Resolució" },
        { label: "Emissor", value: "CNMC" },
...
const ReportsView = () => (
  <div className="space-y-8">
    <div>
      <h1 className="font-manrope font-bold text-2xl md:text-3xl text-foreground">
        REPORTS SETMANALS - TeleConnect España SAU
      </h1>
      <p className="text-muted-foreground mt-2">
      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground leading-relaxed">
            Aquesta setmana hem detectat 14 canvis normatius rellevants per l'operador:
            <br />• 4 alertes crítiques (requereixen acció immediata)
            <br />• 6 alertes mitjanes (seguiment recomanat)
            <br />• 4 alertes informatives (per coneixement)
            <br /><br />
            Setmana intensa amb 2 canvis de gran impacte: obligació cobertura 5G rural i reducció tarifes wholesales.
          </p>
        </div>
        ...
        <div>
          ...
          <div className="space-y-4">
            <HighlightItem
              number="1"
              title="RD 25/2025 (Cobertura rural): €80M inversió obligatòria"
              action="Business case urgent + aprovar capex"
            />
            <HighlightItem
              number="2"
              title="CNMC (Tarifes wholesales): -18% = -€12M/any ingressos"
              action="Renegociar contractes OMVs, ajustar pricing"
            />
            <HighlightItem
              number="3"
              title="Ordre ETD (Transparència): Nous contractes clients"
              action="Dept. Legal revisar templates abans Maig"
            />
          </div>
        </div>
        ...
        <div>
          ...
          <div className="space-y-2">
            <div className="flex items-center gap-2 text-muted-foreground">
              ...
              <span>Cofinançament desplegament rural amb competidors (estalvi 30%)</span>
            </div>
            <div className="flex items-center gap-2 text-muted-foreground">
              <TrendingUp className="h-4 w-4 text-emerald-600" />
              <span>Renegociar acords OMVs abans reducció tarifes obligatòria</span>
            </div>
          </div>
        </div>
      </div>
    ...
    <Card className="p-8 shadow-lg">
      <div className="flex items-center gap-3 mb-4">
        ...
        <div>
          <h2 className="font-manrope font-semibold text-lg text-foreground">
            EMAIL: Alerta Crítica - RD 25/2025
          </h2>
          <p className="text-sm text-muted-foreground">Enviat a: Tots els usuaris (25)</p>
          <p className="text-sm text-muted-foreground">Data: 12 Gen 2025, 09:00</p>
        </div>
      </div>
      ...
      <div className="bg-muted/50 border border-border rounded-lg p-6 mt-6 font-sans">
        <div className="text-sm text-muted-foreground mb-4 space-y-1">
          ...
          <p>Assumpte: 🔴 [CRÍTIC] Nova obligació cobertura 5G rural - Inversió €80M requerida</p>
        </div>
        <div className="border-t-2 border-border my-4" />
        <div className="text-sm text-foreground leading-relaxed space-y-4">
          <p>Hola Miguel,</p>
          <p>
            Avui s'ha publicat el RD 25/2025 que estableix noves obligacions de cobertura 5G
            per a zones rurals amb impacte significatiu.
          </p>
          <div>
            <p className="font-bold">IMPACTE PER TELECONNECT:</p>
            <p>- 240 municipis rurals sense cobertura actual afectats</p>
            <p>- Inversió estimada: €80M (antenes + fibra)</p>
            <p>- Deadline: 31 Desembre 2026</p>
            <p>- Penalització incompliment: fins €10M</p>
          </div>
          <div>
            <p className="font-bold">RECOMANACIÓ:</p>
            <p>Convocar reunió urgent CFO + CTO per aprovar capex i planificar desplegament.</p>
          </div>
          <p>
    ...
    <Card className="p-6">
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1">
          ...
          <p className="text-sm text-muted-foreground">Enviat a: Regulatory Affairs (8) · 15 Gen 2025, 08:00</p>
        </div>
...
const ConfigView = () => (
  <div className="space-y-8">
    <h1 className="font-manrope font-bold text-2xl md:text-3xl text-foreground">
      CONFIGURACIÓ - TeleConnect España SAU
    </h1>
    ...
    <Card className="p-8">
      ...
      <div className="space-y-3">
        <ConfigRow label="Telecomunicacions" priority="Alta" priorityColor="bg-red-100 text-red-900" />
        <ConfigRow label="CNMC i competència" priority="Alta" priorityColor="bg-red-100 text-red-900" />
        <ConfigRow label="Protecció consumidor" priority="Mitjana" priorityColor="bg-amber-100 text-amber-900" />
        <ConfigRow label="Protecció de dades" priority="Mitjana" priorityColor="bg-amber-100 text-amber-900" />
        <ConfigRow label="Fiscal" priority="Baixa" priorityColor="bg-blue-100 text-blue-900" />
      </div>
    </Card>
    ...
    <Card className="p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        {["BOE (Estatal)", "BOCM (Madrid)", "Directives UE (Telecom)", "Resolucions CNMC"].map((source) => (
    ...
    <Card className="p-8">
      <h2 className="font-manrope font-semibold text-lg text-foreground mb-5">
        Usuaris amb accés (25):
      </h2>
      <div className="space-y-3">
        <div className="flex items-center gap-3 text-muted-foreground">
          <Users className="h-5 w-5 text-primary" />
          <span>8 Regulatory Affairs (accés complet)</span>
        </div>
        <div className="flex items-center gap-3 text-muted-foreground">
          <Users className="h-5 w-5 text-primary" />
          <span>12 Legal Counsel (alertes + reports)</span>
        </div>
        <div className="flex items-center gap-3 text-muted-foreground">
          <Users className="h-5 w-5 text-primary" />
    ...
    <Card className={`p-6 border-l-4 ${borderColor} shadow-md`}>
      ...
      {expanded && (
        <div className="mt-6 space-y-6">
          ...
          {businessImpact && (
            <div className="border-t border-border pt-4">
              <p className="font-bold text-sm text-foreground mb-2">IMPACTE PER L'OPERADOR:</p>
